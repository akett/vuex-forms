<template>
    <div>
        ...
        <pre v-highlightjs><code class="shell no-lang">$ npm install html-loader --save-dev</code>
<code class="shell no-lang">$ yarn add html-loader --save</code></pre>
        <p>Then, add a new rule to your webpack configuration:</p>
